...
if [ ! -f "../certs/test_cert_gost2012_256.crt" ]; then
    echo "❌ Файл ../certs/test_cert_gost2012_256.crt не найден"
    exit 1
fi

if [ ! -f "../certs/test_cert_gost2012_256.key" ]; then
    echo "❌ Файл ../certs/test_cert_gost2012_256.key не найден"
    exit 1
fi
...
if openssl x509 -in ../certs/test_cert_gost2012_256.crt -checkend 0 -noout > /dev/null 2>&1; then
